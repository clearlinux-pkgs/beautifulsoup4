...
%prep
%setup -q -n beautifulsoup4-4.9.0
cd %{_builddir}/beautifulsoup4-4.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586384495
...
cp %{_builddir}/beautifulsoup4-4.9.0/COPYING.txt %{buildroot}/usr/share/package-licenses/beautifulsoup4/96063bf55c010062c01e3792177b9fabda28eb82
cp %{_builddir}/beautifulsoup4-4.9.0/LICENSE %{buildroot}/usr/share/package-licenses/beautifulsoup4/1295b7c053fbc5d5bfe3b7aac318703d01d1e227
